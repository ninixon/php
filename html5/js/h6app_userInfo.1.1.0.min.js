!function () {
    var i, prefix, userInfo, shareInfo, query, h6app_userInfo, h6app_shareInfo,
        userInfo_config = window.userInfo_config || {}, config = {
            prefix: "h6",
            ssoUrl: "http://sso.h6app.com/oauth",
            appid: "wx95f30de6c5026cd8",
            scope: "snsapi_base",
            getUnionid: !1,
            version: "1_1_0",
    ...
    prefix = config.prefix, userInfo = {}, shareInfo = {}, query = {
        get: function (a, b) {
            var c = new RegExp("(^|&)" + a + "=([^&]*)(&|$)", "i"), d = location.search.substr(1).match(c);
            ...
            var tmp, pattern = name + "=([^&]*)", replaceText = name + "=" + val,
            ...
            var h, i, c = {}, d = b || location.href, e = d.split("#")[0].split("?"), f = e[0],
        ...
        localStorageKeyName: "h6app_userInfo_" + config.saveAs + config.version, get: function () {
