...
(function (b) {
    var a = {
        fullName: "$baseName.Utility", version: "1.0.0", register: function () {
            ...
            var e = 4, c = c || 1, h = c * e, k = c * 1, d = [], g = 0;
...
(function (a) {
    var b = {
        ...
        getSlotDataFromWapUnion: function (e, j) {
            ...
            var g = this.U.template(i, {slotId: e, callbackName: j, ssi0: f});
            if (/\d+/.test(e)) {
        ...
        getAntiBlockServiceUrl: function () {
            ...
            var e = c[d];
            return {domain: this.U.encodeByMove(e, -1), index: d}
        }
    };
...
(function (p) {
    ...
    var r = function (E, F, B) {
        ...
        F += "height:" + J + "px;";
        return {iframe_style: F, div_style: B, real_w: z, real_h: J}
    };
    ...
    var m = function (V, ab, A, M, Y) {
        ...
        ah = p.create(w.Param, {displayType: o, currentWindow: window, timeStamp: (new Date()).getTime()});
        ah.set("js", b);
        ...
        var K = {iframeId: W, wrapperId: C, bi: E, paramString: O, divStyle: G, iframeStyle: z, starServiceUrl: J};
        ...
        w.adsArray.push({domId: W, uiParamSnap: N, win: window, js: b});
...
(function (d, g) {
    if (g.location.protocol.indexOf("https") > -1) {
        return
    }
    var c = "SOGOU_STAR_URL_CALLBACK";
    var b = "SOGOU_STAR_URL_DATA";
    var e = "http://dsp.brand.sogou.com/wap_ask_service";
    var j = "http://p.inte.sogou.com/wap/js/pe.js";
    var i = function (o) {
        var n = o;
        var m = 0;
